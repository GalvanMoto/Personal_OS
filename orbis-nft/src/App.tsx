...
export default function App() {
  return (
    <div className="relative min-h-screen w-full bg-background text-cream selection:bg-neon selection:text-background overflow-x-hidden">
      {/* Texture Overlay (Fixed z-50 pointer-events-none) */}
      <div
        className="fixed inset-0 z-50 pointer-events-none opacity-60 bg-cover mix-blend-lighten"
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden rounded-b-[32px] bg-background">
        ...
        <div className="relative z-10 max-w-[1831px] w-full mx-auto px-6 sm:px-10 lg:px-16 py-6 sm:py-8 flex flex-col justify-between flex-1">
          ...
          <header className="flex items-center justify-between w-full">
                ...
                {['Homepage', 'Gallery', 'Buy NFT', 'FAQ', 'Contact'].map((item) => (
                  <li key={item}>
                    <a
                      ...
                      className="font-grotesk text-[13px] uppercase text-cream transition-colors duration-200 hover:text-neon"
                    >
                      {item}
                    </a>
                  </li>
            ...
            <div className="hidden lg:flex flex-col gap-3">
              <a
                ...
                className="liquid-glass size-14 rounded-[1rem] flex items-center justify-center text-cream hover:bg-white/10 transition-colors"
                aria-label="Email"
              >
          ...
          <div className="my-auto py-12 lg:py-0">
            <div className="relative max-w-[780px] lg:ml-32">
              ...
              <span className="font-condiment text-[24px] sm:text-[34px] md:text-[42px] lg:text-[48px] normal-case text-neon mix-blend-exclusion opacity-90 absolute right-0 sm:-right-8 md:-right-12 top-1/2 -translate-y-1/2 -rotate-1 pointer-events-none select-none">
                Nft collection
              </span>
            </div>
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden bg-background py-16 sm:py-20 lg:py-24">
        {/* Background Looping Video */}
        <video
          autoPlay
          loop
        ...
        <div className="relative z-10 max-w-[1831px] w-full mx-auto px-6 sm:px-10 lg:px-16 flex flex-col justify-between flex-1">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-8 pt-4 sm:pt-8">
            ...
            <div className="relative inline-block">
              <h2 className="font-grotesk text-[32px] sm:text-[44px] md:text-[52px] lg:text-[60px] uppercase leading-tight text-cream">
                Hello!
                <br />
                I&apos;m orbis
              </h2>
              ...
              <span className="font-condiment text-[36px] sm:text-[48px] md:text-[58px] lg:text-[68px] normal-case text-neon mix-blend-exclusion absolute -bottom-4 right-0 sm:-right-6 -rotate-2 pointer-events-none select-none">
                Orbis
              </span>
            </div>
          ...
          <div className="flex justify-between items-end gap-12 mt-auto pt-16">
            ...
            <div className="space-y-4 max-w-[340px] font-mono text-[14px] uppercase text-[#010828] lg:text-cream lg:opacity-10 leading-relaxed">
            ...
            <div className="hidden lg:block space-y-4 max-w-[340px] font-mono text-[14px] uppercase text-cream opacity-10 leading-relaxed text-right">
              <p>A digital object fixed beyond time and place. An exploration of distance, form, and silence in space</p>
              <p>A digital object fixed beyond time and place. An exploration of distance, form, and silence in space</p>
            </div>
          </div>
      ...
      {/* =========================================================================
         ...
         ========================================================================= */}
      <section id="gallery" className="relative w-full bg-background py-20 sm:py-28 lg:py-36">
        <div className="max-w-[1831px] w-full mx-auto px-6 sm:px-10 lg:px-16">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-8 mb-12 sm:mb-16 lg:mb-20">
            {/* Left Heading */}
            <div className="font-grotesk text-[32px] sm:text-[44px] md:text-[52px] lg:text-[60px] uppercase leading-[1.1] text-cream">
              <div>Collection of</div>
              <div className="ml-12 sm:ml-24 lg:ml-32 flex items-baseline gap-3">
                <span className="font-condiment text-neon normal-case text-[1.15em] leading-none">
                  Space
                </span>
                <span>objects</span>
              </div>
            ...
            <button className="group flex flex-col items-start cursor-pointer transition-transform active:scale-95">
              <div className="flex items-center gap-3 font-grotesk uppercase">
                <span className="text-[32px] sm:text-[44px] md:text-[52px] lg:text-[60px] leading-none text-cream">
                  SEE
                </span>
                <div className="flex flex-col text-[20px] sm:text-[24px] md:text-[30px] lg:text-[36px] leading-[0.88] text-cream text-left">
                  <span>ALL</span>
                  <span>CREATORS</span>
                </div>
              </div>
              <div className="w-full bg-neon h-[6px] sm:h-[8px] lg:h-[10px] mt-2 rounded-full transition-transform duration-300 group-hover:scale-x-105 origin-left" />
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {nftCards.map((card) => (
              ...
              >
                ...
                <div className="relative w-full pb-[100%] rounded-[24px] overflow-hidden bg-background/50">
                  <video
                    autoPlay
                    loop
                    muted
      ...
      <section className="relative w-full bg-background overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6 sm:p-10 lg:p-16 pointer-events-none">
          ...
          <div className="self-end lg:pr-[20%] lg:pl-[15%] text-right relative pointer-events-auto mt-4 sm:mt-8 md:mt-12 lg:mt-20">
            ...
            <span className="font-condiment text-neon text-[17px] sm:text-[32px] md:text-[48px] lg:text-[68px] normal-case mix-blend-exclusion absolute -top-3 sm:-top-7 md:-top-10 lg:-top-14 left-0 -translate-x-1/2 -rotate-2 select-none">
              Go beyond
            </span>

            {/* Heading */}
            <div className="font-grotesk uppercase text-[16px] sm:text-[30px] md:text-[45px] lg:text-[60px] leading-[1.05] text-cream">
          ...
          <div className="absolute left-[8%] bottom-[12%] sm:bottom-[15%] md:bottom-[18%] lg:bottom-[20%] pointer-events-auto">
            <div className="liquid-glass rounded-[0.5rem] sm:rounded-[0.75rem] md:rounded-[1rem] lg:rounded-[1.25rem] flex flex-col overflow-hidden shadow-2xl">
              <a
                href="mailto:contact@orbis.nft"
                className="w-[14vw] sm:w-[14.375rem] md:w-[10.78125rem] lg:w-[16.77rem] h-[7vw] sm:h-[4.5rem] md:h-[4rem] lg:h-[5.5rem] flex items-center justify-center text-cream hover:bg-white/10 transition-colors border-b border-white/10"
                aria-label="Email"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-[14vw] sm:w-[14.375rem] md:w-[10.78125rem] lg:w-[16.77rem] h-[7vw] sm:h-[4.5rem] md:h-[4rem] lg:h-[5.5rem] flex items-center justify-center text-cream hover:bg-white/10 transition-colors"
                aria-label="GitHub"
              >
                <Github />
              </a>
